...
async function main() {
  ...
  await prisma.appUpdate.upsert({
    ...
    update: {
      ...
      downloadUrl: 'https://files.catbox.moe/4ue1ko.zip',
      checksum: 'sha256:a9ba232fa2afcfc58dea0f0c89efb0d59093421152637fa426dbf13c4b3fcd3a',
      fileSize: BigInt(155052579),
      channel: 'STABLE',
    },
    create: {
      version: '0.1.0',
